...
table = [...
      0.1,0.2,    sin(0.1)-eps(sin(0.1)),sin(0.2)+eps(sin(0.2));...
      1.7,1.8,    sin(1.8)-eps(sin(1.8)),sin(1.7)+eps(sin(1.7));...
      1.5,1.6,    sin(1.5)-eps(sin(1.5)),1;...
      4.7,4.8,    -1,sin(4.8)+eps(sin(4.8));...
      1.5,4.8,    -1,1];
...
table = [...
      0.1,0.2,    cos(0.2)-eps(cos(0.2)),cos(0.1)+eps(cos(0.1));...
      3.2,3.3,    cos(3.2)-eps(cos(3.2)),cos(3.3)+eps(cos(3.3));...
     -0.1,0.2,    cos(0.2)-eps(cos(0.2)),1;...
      3.0,3.5,    -1,cos(3.5)+eps(cos(3.5));...
     -0.1,3.5,    -1,1];
